package com.avangard.bratstvo.intro.interests.presentation.adapter
...
class IntroInterestsAdapter(private val chipGroup: ChipGroup) {

    var items: List<InterestUiModel>? = null
        set(value) {
            field = value
